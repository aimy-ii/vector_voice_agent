...
class FarewellDecision(BaseModel):
    ...
    conversation_ended: bool = Field(
        default=False,
        description="True только если собеседник попрощался или дал понять, что больше говорить не намерен.",
    )
...
class LlmFarewellAgent:
    ...
    async def decide(
        ...
        system = (
            ...
            "Разговор закончен, когда собеседник попрощался или дал понять, "
            "что больше говорить не намерен.\n"
            "Договорённость о встрече, запись, обещание прислать документы, "
            "благодарность и вопрос собеседника — не конец разговора.\n"
