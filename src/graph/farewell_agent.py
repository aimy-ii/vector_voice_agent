...
FAREWELL_SYSTEM = (
    ...
    "2. Он сказал, что дальше говорить не будет — не про эту тему, а вообще: "
    "«мне пора», «я за рулём», «я на работе», «перезвоните позже», "
    "«давайте потом», «хватит», «я уже отвечал».\n"
    ...
    "\n"
    "Отказ от темы и отказ от разговора — разные вещи, и путать их нельзя. "
    "Бот спросил, удобно ли сейчас обсудить стоимость, дату, документы — "
    "и услышал «нет», «неудобно», «не сейчас», «потом»: это отказ от темы, "
    "разговор продолжается, не конец. Человек сам сказал, что не может "
    "говорить вообще — «мне пора», «я за рулём», «перезвоните позже» — "
    "это конец, даже если сказано в ответ на вопрос бота.\n"
    "Различать по тому, от чего человек отказался: от одной темы или от "
    "разговора целиком. Реплика бота перед ответом видна в диалоге ниже — "
    "по ней и смотреть, на что человек отвечает.\n"
    "\n"
    ...
    "не хочу рассрочку;\n"
    "— отказ обсуждать тему сейчас в ответ на вопрос бота: «неудобно», "
    "«не сейчас», «потом», «не хочу об этом»;\n"
