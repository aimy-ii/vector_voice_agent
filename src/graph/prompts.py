...
SPEECH_RULES: tuple[str, ...] = (
    ...
    (
        ...
        "Нельзя спрашивать про темп, объём, порядок и формат подачи: «сразу всю "
        "информацию или по шагам?», «подробно или коротко?», «с чего начать?», "
        "«сначала про практику или про цену?», «рассказать сейчас или позже?». "
        "Форма выбора такой вопрос не спасает: выбор между «сразу всё» и «по "
        "шагам» — это по-прежнему про сам разговор. Проверка простая: если ответ "
        "собеседника меняет только то, КАК агент говорит, вопрос негоден; если "
        "меняет то, О ЧЁМ договорились — город, коробка, филиал, оплата, время "
        "встречи — вопрос годен и нужен."
    ),
    (
