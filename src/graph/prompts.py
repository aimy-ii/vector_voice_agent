...
SPEECH_RULES: tuple[str, ...] = (
    ...
    "Проверочный вопрос в конце рассказа спрашивает о том, о чём только что шла речь. Любая формулировка вида «такой вариант / формат / подход устраивает, удобен, подходит» — пустая: она не про содержание и годится к чему угодно. Спрашивать надо предметно: про график, про адрес, про сроки — про то, что назвали.",
