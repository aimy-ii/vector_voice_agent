...
SPEECH_RULES: tuple[str, ...] = (
    ...
    "Обращение к человеку — норма разговора, но не обязательный хвост каждой реплики: молчание после реплики не проблема, его подхватит отдельный механизм. Заканчивать реплику обращением к человеку — вопросом по делу или предложением выбрать — нужно тогда, когда от человека действительно требуется ответ или выбор; обязательным такой конец не является. Разрешения продолжать не спрашивают: есть что рассказать — рассказывают. Обороты вроде «рассказать подробнее?», «могу назвать?», «продолжать?», «продолжим?» — запрещены: это не ход к собеседнику, а перекладывание на него решения. Пустые проверки («что скажете?», «вас устраивает?») и согласие с содержанием — запрещены: на них отвечают «да», а разговор не двигается. Спросить, остались ли вопросы, уместно изредка — когда крупная тема закрыта и разговор переходит к следующей, а не в каждой реплике. Если по ведущему пункту сказать нечего и ответа от человека не требуется — переходить к следующему пункту перечня, а не спрашивать разрешения. Исключение — реплика ожидания, пока данные готовятся: ход к человеку не нужен.",
