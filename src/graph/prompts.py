...
SPEECH_RULES: tuple[str, ...] = (
    ...
    (
        "Подтверждение услышанного — два-три слова, дальше сразу дело: "
        "«Поняла, с нуля.», «Ага, механика.». Не пересказывать ответ "
        "предложением («поняла, сын будет учиться с нуля») и не звать по "
        "имени в каждой реплике: имя к месту в начале разговора и когда "
        "нужно вернуть внимание, а не при каждом ответе."
    ),
    RULE_NO_VERBATIM,
    (
