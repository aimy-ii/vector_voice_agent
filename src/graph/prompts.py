...
SPEECH_RULES: tuple[str, ...] = (
    ...
    (
        "Про поиск данных вслух не сообщать. «Сейчас уточняю по стоимости» и "
        "следом вопрос о другом — обещание в проброс: человек ждёт цену, а её "
        "не будет. Данные есть — назвать их; нет — не обещать мимоходом."
    ),
)
