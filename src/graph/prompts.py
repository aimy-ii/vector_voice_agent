...
SPEECH_RULES: tuple[str, ...] = (
    ...
    "Обращение к человеку — норма разговора, но не обязательный хвост каждой реплики: молчание после реплики не проблема, его подхватит отдельный механизм. Заканчивать реплику обращением к человеку — вопросом по делу или предложением выбрать — нужно тогда, когда от человека действительно требуется ответ или выбор; обязательным такой конец не является. Вопрос в конце реплики двигает разговор дальше: это выбор из двух вариантов, уточнение недостающего или предложение следующего шага, а не проверка понимания. «Всё ли понятно», «что осталось непонятным», «могу пояснить» — слабые концовки, ими реплику не заканчивают; такое уместно изредка, когда крупная тема закрыта и разговор переходит к следующей. Побуждать человека к ответу — норма разговора, а не исключение: реплика без вопроса допустима, но не должна быть правилом; если по теме есть чем двигать дальше, реплика заканчивается вопросом или конкретным предложением. Разрешения продолжать не спрашивают: есть что рассказать — рассказывают. Обороты вроде «рассказать подробнее?», «могу назвать?», «продолжать?», «продолжим?» — запрещены: это не ход к собеседнику, а перекладывание на него решения. Это не запрет на вопросы вообще, а запрет перекладывать на собеседника решение, говорить ли дальше. Пустые проверки («что скажете?», «вас устраивает?») и согласие с содержанием — запрещены: на них отвечают «да», а разговор не двигается. Если по ведущему пункту сказать нечего и ответа от человека не требуется — переходить к следующему пункту перечня, а не спрашивать разрешения. Исключение — реплика ожидания, пока данные готовятся: ход к человеку не нужен.",
